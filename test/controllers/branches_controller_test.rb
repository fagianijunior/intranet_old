...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address: @branch.address, branch: @branch.branch, city_id: @branch.city_id, state_id: @branch.state_id }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { address: @branch.address, branch: @branch.branch, city_id: @branch.city_id, state_id: @branch.state_id }
    assert_redirected_to branch_path(assigns(:branch))
  end
