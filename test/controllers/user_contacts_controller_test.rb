...
class UserContactsControllerTest < ActionController::TestCase
  ...
  test "should create user_contact" do
    assert_difference('UserContact.count') do
      post :create, user_contact: { contact: @user_contact.contact, contacttype_id: @user_contact.contacttype_id, user_id: @user_contact.user_id }
    end
  ...
  test "should update user_contact" do
    patch :update, id: @user_contact, user_contact: { contact: @user_contact.contact, contacttype_id: @user_contact.contacttype_id, user_id: @user_contact.user_id }
    assert_redirected_to user_contact_path(assigns(:user_contact))
  end
